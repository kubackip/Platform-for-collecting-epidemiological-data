...
@Entity(name = "mazowieckie")
public class EpidemicData2 {
	...
	public EpidemicData2(int id, String choroba, int ilosc, int rok) {
		super();
		this.id = id;
		this.choroba = choroba;
		this.ilosc = ilosc;
	...
	public EpidemicData2(String choroba, int ilosc, int rok) {
		super();
		this.choroba = choroba;
		this.ilosc = ilosc;
		this.rok = rok;
